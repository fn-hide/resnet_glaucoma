...
class Model:
    ...
    def ssr(img, sigma):
        ...
        return np.log10(img) - np.log10(Model.get_gaussian_blur(img, ksize=0, sigma=sigma) + 1.0)
    ...
    def msr(img, sigma_scales=[15, 80, 250]):
        ...
        msr = cv.normalize(msr, None, 0, 255, cv.NORM_MINMAX, dtype=cv.CV_8UC3)
    ...
    def msrcr(img, sigma_scales=[15, 80, 250], alpha=125, beta=46, G=192, b=-30, low_per=1, high_per=1):
        ...
        msr_img = Model.msr(img, sigma_scales)
        ...
        msrcr = Model.color_balance(msrcr, low_per, high_per)
    ...
    def msrcp(img, sigma_scales=[15, 80, 250], low_per=1, high_per=1):
        ...
        msr_int = Model.msr(int_img, sigma_scales)
        # color balance of MSR
        msr_cb = Model.color_balance(msr_int, low_per, high_per)
